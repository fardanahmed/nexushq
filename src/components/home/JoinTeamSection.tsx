...
const JoinTeamSection = () => {
  ...
  return (
    <section
      id="join"
      className="py-24 md:py-32 bg-[#030014]/90 backdrop-blur-sm border-t border-white/5 relative overflow-hidden"
    >
      {/* Dynamic Portal Background */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full opacity-30 mix-blend-screen animate-[spin_40s_linear_infinite]"
          style={{
            background:
              'conic-gradient(from 0deg, transparent, rgba(99, 102, 241, 0.2), rgba(124, 58, 237, 0.4), rgba(245, 158, 11, 0.2), transparent)',
          }}
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-20 mix-blend-screen animate-[spin_25s_linear_infinite_reverse]"
          style={{
            background:
              'conic-gradient(from 180deg, transparent, rgba(124, 58, 237, 0.3), rgba(245, 158, 11, 0.1), transparent)',
          }}
        />
      </div>
        ...
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          ...
          <div className="space-y-8 lg:max-w-md animate-fadeInUp">
            ...
            <p className="text-slate-400 text-base md:text-lg leading-relaxed font-medium">
              Join the NexusHQ private beta to secure early access, lifetime
              launch discount rates, and help shape the command centre for
              modern mentors.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href="/features"
                className="inline-flex items-center gap-2 text-indigo-400 hover:text-indigo-300 font-bold group transition-colors"
              >
                <span className="border-b border-transparent group-hover:border-indigo-400 pb-0.5">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 mt-2 font-medium">
                      ...
                      <span className="text-indigo-300">{formData.email}</span>{' '}
                      as soon as your slot opens.
                    </p>
                  </div>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2 group/input relative">
                    <label
                      htmlFor="fullName"
                      className="text-sm font-semibold text-slate-350 transition-colors group-focus-within/input:text-indigo-300"
                    >
                      Full Name
                    </label>
                    <input
