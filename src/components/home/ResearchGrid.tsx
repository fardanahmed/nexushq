...
const ResearchGrid = ({ areasPromise }: ResearchGridProps) => {
      ...
      <div className="mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-4 max-w-3xl text-muted-foreground">
            Our interdisciplinary teams are tackling the most pressing
            challenges of our time.
          </p>
        </div>
        <Button
          variant="ghost"
          className="group text-primary hover:text-primary/80 hover:bg-primary/10"
          asChild
        >
          <Link href="/research">
            View All Areas{' '}
            ...
            >
              <Card className="group relative overflow-hidden border-border bg-card transition-all hover:bg-accent/50 hover:shadow-lg hover:border-primary/50 h-full">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="line-clamp-2 text-xl text-card-foreground">
                    {area.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
