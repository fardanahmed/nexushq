    ...
    <section className="container mx-auto px-4 py-24 bg-background">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {researchAreas.map((area: any) => {
          ...
          return (
            <Card key={area.id} className="group relative overflow-hidden border-border bg-card transition-all hover:bg-accent/50 hover:shadow-lg hover:border-primary/50">
